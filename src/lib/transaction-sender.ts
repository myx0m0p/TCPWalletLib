...
class TransactionSender {
   ...
   * @return {Promise<Object>}
   */
  static async sendTokens(accountNameFrom, privateKey, accountNameTo, amount, memo = '', symbol = TOKEN_SYMBOL) {
   ...
   * @private
   */
  static getUosAmountAsString(amount, symbol = TOKEN_SYMBOL): string {
